...
class UpdateLibBookDTO
{
     ...
     * @return LibBook
     */
    public function getLibBook(): LibBook
    {
        return $this->lib_book;
    }

    /**
     * @param LibBook $lib_book
     */
    public function setLibBook(LibBook $lib_book): void
    {
        $this->lib_book = $lib_book;
    }
}
